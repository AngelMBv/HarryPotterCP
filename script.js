document.addEventListener("DOMContentLoaded", function () {
    ...
    // Definir una lista de personajes con sus respectivas casas
    const personajes = {
        harry: "gryffindor",
        ron: "gryffindor",
        hermione: "gryffindor",
    ...
    casaSelector.addEventListener("change", function () {
        ...
        // Establece los detalles de la casa aquí
        switch (selectedCasa) {
            case "gryffindor":
        ...
        // Actualizar el segundo select con personajes de la casa seleccionada
        ...
        for (const personaje in personajes) {
            if (personajes[personaje] === selectedCasa) {
                ...
                option.textContent = personaje.charAt(0).toUpperCase() + personaje.slice(1); // Mayúscula inicial
    ...
    personajeSelector.addEventListener("change", function () {
        ...
        // Establece los detalles del personaje aquí
